...
simfiles_spec = [\
['particles.d11_A0.5Hepp_beta0.5eps1e-4_256',2,[0],[1]],\
...
['particles.d11_pv1Ap2Apb2betac0.214betab0.858_128_128x2_dx0.75_t3000',2,[0,1],[]],\
['particles.d11_pv2a_128x3_iden0eps1e-4_dx0.75',3,[0,1],[2]],\
['particles.d11_pv2Ap1Ab1betac0.429betab0.858_128_128x2_dx0.75_t3000',2,[0,1],[]],\
['particles.d11_pv2Ap1Ab2betac0.429betab0.858_128_128x2_dx0.75_t3000',2,[0,1],[]],\
['particles.d11_pv2Ap2Apb2betac0.214betab0.858_128_128x2_dx0.75_t3000',2,[0,1],[]],\
['particles.d11_pv2av2.3_128x3_iden0eps1e-4_dx0.75',4,[0,1],[2,3]],\
['particles.d11_pv2av2Ap1Aa1beta0.429_128_128x2_dx0.75_t3000',4,[0,1],[2,3]],\
...
for simfile_spec in simfiles_spec:
    ...
    if (simfile_sh != 'particles.d11_pv2av2.3_128x3_iden0eps1e-4_dx0.75'):
        ...
        nsim, header = kr.show_fileinfo(simfile,kspi=kspi,nsim_out=True,limframe=64)
    print("-------------- READING VDFS -----------------")
    ...
    # saving moments
    anisotropies_he[np.where(np.isnan(anisotropies_he))] = 0.0
    moments_he[np.where(np.isnan(moments_he))] = 0.0
