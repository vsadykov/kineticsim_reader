...
def return_selectedframe(filename, framenumber):
    """
...
def save_simulationframes(filename, outfile_stamp, foldername, framestart = 0, frameend = -1):
    """
