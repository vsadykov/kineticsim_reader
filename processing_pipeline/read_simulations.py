...
simfile = '../particles.d11_E11Ap3.3Aa2.0Vd0.42'
foldername = './outputs/outputs.d11_E11Ap3.3Aa2.0Vd0.42/'
# number of species
kspi = 2
...
header = kr.show_fileinfo(simfile,kspi=kspi)

print("-------------- SAVING FILES INTO THE FOLDER -----------------")
kr.save_simulationframes(simfile, 'distributions.', foldername, framestart = 0, frameend = -1, kspi=kspi)
